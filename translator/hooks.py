...
app_description = "Translation Portal for Dataent Apps"
app_icon = "icon-comment"
app_color = "green"
app_email = "info@dataent.io"
app_url = "https://dataent.io"
app_version = "0.0.1"
...
website_context = {
	"brand_html": "<img class='navbar-icon' src='/assets/dataent_theme/img/erp-icon.svg' />EPAAS Translator",
	"top_bar_items": [
...
# 	"dataent.desk.doctype.event.event.get_events": "translator.event.get_events"
# }
