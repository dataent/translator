...
var translator = {
	...
	update: function(callback) {
		...
		if(!val) {
			dataent.msgprint("Please enter translated text");
			return;
		}
	...
	activate: function($div) {
		if(dataent.get_cookie("sid")==="Guest") {
			dataent.msgprint("Please <a href='/login'>login</a> to edit / verify");
			return;
		}
		...
		if(verified && window.user_karma < 100) {
			dataent.msgprint("You need 100 karma to edit verified translations.");
			return;
		}
